# Régénère analyse-financiere-entreprise.zip à partir des sources du skill.
#
...
$dest = Join-Path $repoRoot "analyse-financiere-entreprise.zip"
...
Write-Host "analyse-financiere-entreprise.zip régénéré ($size octets)."
