# Régénère generation-cours.zip à partir des sources du skill.
#
...
# chemins avec des antislashs (ex. "examples\README.md"), ce qui viole la norme ZIP
...
$dest = Join-Path $repoRoot "generation-cours.zip"
...
Write-Host "generation-cours.zip régénéré ($size octets)."
